...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Product[] products = {new ComputerCase(), new CPU(), new MemoryDDR5(), new Notebook()};
        printProucts(products); //принцип DRY - повторяющийся вывод списка продуктов на экран выносим в отдельный метод
